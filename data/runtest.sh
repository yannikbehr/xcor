...
MAIN=/Users/home/carrizad/Desktop/xcorr/xcorr_git/
CONFIG=config.txt
LOG=run_log.txt
mypython=/usr/bin/python26
# write configuration file
cat > ${CONFIG} <<EOF
[seed2sac]
rdseedir=/usr/local/bin/rdseed475/
bindir=../bin/                                   
...
[mseed2sac]
rdseed=/usr/local/bin/rdseed475      
bindir=../bin/                                   
mseedir=/Volumes/GeoPhysics_03/users-data/carrizad/night/miniseed/NIGHT_passive_miniseed_Z.4705                           
sacfiles=/Volumes/GeoPhysics_03/users-data/carrizad/night/sac/NIGHT                          
dataless=/Volumes/GeoPhysics_03/users-data/carrizad/night/miniseed                  
respfiles=/Volumes/GeoPhysics_03/users-data/carrizad/night/RespFiles
search_pattern=*.D
