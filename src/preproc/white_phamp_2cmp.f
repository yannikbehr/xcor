...
c ==========================================================
     ...
     2    seis_outph_E,seis_outph_N,ns,dom)
      ...
      real*4    seis_in_E(4320000),seis_out_E(4320000)
      real*4   seis_outamp_E(4320000), seis_outph_E(4320000)
      real*4    seis_in_N(4320000),seis_out_N(4320000)
      real*4   seis_outamp_N(4320000), seis_outph_N(4320000)
c ---
      integer*4 k,ns,nk,i
      real*8    plan1_E,plan2_E
      real*8    plan1_N,plan2_N
      real*8    dom
      double complex czero,s_E(4320000),sf_E(4320000)
      double complex s_N(4320000),sf_N(4320000)
c ---
      czero = (0.0d0,0.0d0)
...
c===============================================================
      ...
      integer*4 nk,npow
      double complex sf_E(4320000),sf_N(4320000)
